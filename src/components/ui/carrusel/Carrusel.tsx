...
const images = [
  ...
  {
    src: '/carrusel/3.webp',
    description: 'Finca El Troncón. Principal masa ganadera. Ganadero Nolberto Santiesteban',
  },
  {
    src: '/carrusel/4.webp',
    description: 'Finca El Troncón. Minindustria en finca colindante La Gloria',
  },
  {
    src: '/carrusel/5.webp',
    description:
      'Carlos Pozo Ramírez, ganadero que transformó su finca en un polígono de experimentación para obtener Bovinos mejor adaptado al cambio climático.',
  },
  {
    src: '/carrusel/6.webp',
    description: 'Coto de reserva de caza Las Maravillas Extensión 52 Hectáreas',
  },
  {
    src: '/carrusel/7.webp',
    description:
      'Sendero de la finca, mostrando la organización de las áreas para la producción y el pastoreo.',
  },
  {
    src: '/carrusel/8.webp',
    description: 'Infraestructura de la finca: molino de viento para agua y corrales de manejo.',
  },
  {
    src: '/carrusel/9.webp',
